...
//
//}
TEST_CASE("Centipede moves then hits  right wall and moves down - this one involves the collision")
{
...
TEST_CASE("Centipede train moves then hits  right wall and moves down - this one involves the collision")
{
...
{
    std::vector<Movement> moves(29, Movement:Down);
    std::vector<Segment> seg;
    seg.push_back(2.f,781.f);
    Centipede centipede();
    for(int i=0; i<11372; i++)
   {
       centipede.Move();
    }

        CHECK(centipede.getMoves().at(10)==Movement::Up);
